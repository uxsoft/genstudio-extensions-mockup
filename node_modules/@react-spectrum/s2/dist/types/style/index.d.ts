...
import { Inset, Spacing } from './spectrum-theme';
 ...
 */
export declare function space(px: number): `[${string}]`;
/**
 ...
 */
export declare function fontRelative(base: number, baseFontSize?: number): `[${string}]`;
/**
...
export declare const focusRing: () => {
    ...
    readonly outlineColor: {
        readonly default: "focus-ring";
        readonly forcedColors: "Highlight";
    };
 ...
 */
export declare function iconStyle(this: MacroContext | void, options: IconStyle): StyleString<Exclude<keyof IconStyle, 'color' | 'size'>>;
