@layer _.a {
  ...
  .-AJjOLd-UCwrhQe131 {
    --field-gap: calc((calc(var(--field-height) + var(--track-to-label)) - var(--_k, 0px) - var(--h, 0px) - 1lh) / 2);
  }
  ...
  .pv131 {
    color: light-dark(#505050, #afafaf);
  }

  .pp131 {
    color: light-dark(#c6c6c6, #444);
  }
  ...
  .gE131 {
    background-color: light-dark(#dadada, #393939);
  }
  ...
  .gG1ze4d131 {
    background-color: light-dark(#4b75ff, #5681ff);
  }

  .gp17Jm131 {
    background-color: light-dark(#079355, #099d59);
  }

  .g9VrKkd131 {
    background-color: light-dark(#d45b00, #e06400);
  }

  .gFLVMS131 {
    background-color: light-dark(#f03823, #fc432e);
  }
...
@layer _.b {
  ...
  ._FnuYUweb131:is(:lang(ja), :lang(ko), :lang(zh), :lang(zh-Hant), :lang(zh-Hans), :lang(zh-CN), :lang(zh-SG)) {
    line-height: 1.5;
  }
}
...
@layer _.i {
  .uic131:is(:lang(zh-Hans), :lang(zh-CN), :lang(zh-SG)) {
...
/*# sourceMappingURL=Meter.css.map */
