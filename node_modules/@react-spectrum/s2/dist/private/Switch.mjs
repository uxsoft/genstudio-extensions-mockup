...
import {HelpText as $9afd80978c252040$export$a67c0bc59081311a} from "./Field.mjs";
import {pressScale as $10ea7662e51a285b$export$56e8cba416805d8d} from "./pressScale.mjs";
import {useFocusableRef as $80ecb974df713a30$export$96a734597687c040} from "./useDOMRef.mjs";
...
import {SwitchField as $8aRsI$SwitchField, SwitchButton as $8aRsI$SwitchButton} from "react-aria-components/Switch";
import {useLocale as $8aRsI$useLocale} from "react-aria/I18nProvider";
...
const $8926b17b75ae985d$var$field = function anonymous(props, overrides) {
    let rules = " ";
    let width = false;
    ...
    rules += ' se131';
    if (props.isNoVisibleLabel) rules += ' DtyCQZ131';
    else rules += ' DE5iebb131';
    rules += ' qf131';
    if (!width) rules += ' ZJ131';
    if (props.size === "XL") {
        rules += ' uk131';
        rules += ' ucJ9TBTb131';
        rules += ' ud3Euai131';
    ...
    rules += ' UVxyPec131';
    if (props.isInForm) {
        if (!gridColumnStart) rules += ' zhJUGr131';
    }
    return rules;
};
const $8926b17b75ae985d$var$wrapper = function anonymous(props) {
    let rules = " ";
    rules += ' se131';
    rules += ' DLwlgod131';
    rules += ' z2mU131';
...
const $8926b17b75ae985d$var$track = function anonymous(props) {
    ...
    rules += ' kg131';
    rules += ' jg131';
    rules += ' -ERv7Xb-ZmDIzbc131';
    if (props.size === "XL") rules += ' -LsrJQc-Fn131';
    else if (props.size === "L") rules += ' -LsrJQc-Fm131';
    else if (props.size === "S") rules += ' -LsrJQc-Fl131';
    else rules += ' -LsrJQc-Ft131';
    rules += ' ZAkyXj131';
    rules += ' Fpk5ROc131';
    rules += ' _oa131';
    rules += ' _kc131';
    ...
    rules += ' _2b131';
    rules += ' _yb131';
    if (props.isSelected) rules += ' iA131';
    else if (props.isDisabled) {
        rules += ' io131';
        rules += ' ilc131';
    } else {
        if (props.isPressed) rules += ' in131';
        else if (props.isFocusVisible) rules += ' in131';
        else if (props.isHovered) rules += ' in131';
        else rules += ' iv131';
        rules += ' ila131';
    }
    if (props.isSelected) {
        if (props.isDisabled) {
            ...
            if (props.isEmphasized) {
                if (props.isPressed) rules += ' gY131';
                else if (props.isFocusVisible) rules += ' gY131';
                else if (props.isHovered) rules += ' gY131';
                else rules += ' g3131';
            } else {
                if (props.isPressed) rules += ' gu131';
                else if (props.isFocusVisible) rules += ' gu131';
                else if (props.isHovered) rules += ' gu131';
                else rules += ' g0131';
            }
            rules += ' gle131';
        }
...
const $8926b17b75ae985d$var$handle = function anonymous(props) {
    ...
    rules += ' kg131';
    rules += ' jg131';
    if (props.isSelected) rules += ' gX131';
    else if (props.isDisabled) {
        rules += ' gw131';
        rules += ' gld131';
    } else {
...
const $8926b17b75ae985d$export$b5d5cf8927ab7262 = /*#__PURE__*/ (0, $8aRsI$forwardRef)(function Switch(props, ref) {
    ...
    let domRef = (0, $80ecb974df713a30$export$96a734597687c040)(ref, inputRef);
    ...
    return /*#__PURE__*/ (0, $8aRsI$jsx)((0, $8aRsI$SwitchField), {
        ...props,
        ref: domRef,
        inputRef: inputRef,
        style: UNSAFE_style,
        className: (renderProps)=>UNSAFE_className + $8926b17b75ae985d$var$field({
                ...renderProps,
                isInForm: isInForm,
                size: props.size || 'M',
                isNoVisibleLabel: !children
            }, props.styles),
        children: ({ isDisabled: isDisabled, isInvalid: isInvalid })=>/*#__PURE__*/ (0, $8aRsI$jsxs)((0, $8aRsI$Fragment), {
                children: [
                    /*#__PURE__*/ (0, $8aRsI$jsx)((0, $8aRsI$SwitchButton), {
                        className: (renderProps)=>$8926b17b75ae985d$var$wrapper({
                                ...renderProps,
                                isInForm: isInForm,
                                size: props.size || 'M'
                            }),
                    ...
                    /*#__PURE__*/ (0, $8aRsI$jsx)((0, $9afd80978c252040$export$a67c0bc59081311a), {
                        size: props.size || 'M',
                        styles: " z2mU131 Td131",
