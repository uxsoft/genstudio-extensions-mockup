...
var $5RNes$reactariacomponentsProgressBar = require("react-aria-components/ProgressBar");
...
const $1c116ea4b0d2d023$var$wrapper = function anonymous(props, overrides) {
    ...
    if (props.staticColor === "white") rules += ' -Ovbhqd-gcwrnr131';
    else if (props.staticColor === "black") rules += ' -Ovbhqd-g4hn3s131';
    if (props.size === "L") {
        if (!width) rules += ' ZG131';
    } else if (props.size === "S") {
        if (!width) rules += ' Zu131';
    } else if (!width) rules += ' ZC131';
    if (props.size === "L") {
        if (!height) rules += ' FA131';
    } else if (props.size === "S") {
        if (!height) rules += ' Ft131';
    } else if (!height) rules += ' Fx131';
    rules += ' fa131';
    return rules;
};
const $1c116ea4b0d2d023$var$track = function anonymous(props) {
    let rules = " ";
    if (props.isStaticColor) rules += ' Vd131';
    else rules += ' Vf131';
    rules += ' Vla131';
    if (props.size === "L") rules += ' _VuNalie131';
    else if (props.size === "S") rules += ' _V7m7Gv131';
    else rules += ' _Vwtfhvc131';
    if (props.size === "L") rules += ' _Vlwtfhvc131';
    else if (props.size === "S") rules += ' _Vlai5a0131';
    else rules += ' _Vl7m7Gv131';
    return rules;
};
const $1c116ea4b0d2d023$var$fill = function anonymous(props) {
    let rules = " ";
    if (props.isStaticColor) rules += ' Ve131';
    else rules += ' Vh131';
    rules += ' VlUG8Hlc131';
    rules += ' _Sa131';
    rules += ' _0d131';
...
const $1c116ea4b0d2d023$export$c79b9d6b4cc92af7 = /*#__PURE__*/ (0, $5RNes$react.forwardRef)(function ProgressCircle(props, ref) {
    ...
    return /*#__PURE__*/ (0, $5RNes$reactjsxruntime.jsx)((0, $5RNes$reactariacomponentsProgressBar.ProgressBar), {
        ...props,
        ref: domRef,
        style: UNSAFE_style,
