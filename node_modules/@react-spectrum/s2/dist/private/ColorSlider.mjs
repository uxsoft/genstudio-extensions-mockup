...
import {ColorSlider as $3i9ps$ColorSlider} from "react-aria-components/ColorSlider";
import {createContext as $3i9ps$createContext, forwardRef as $3i9ps$forwardRef, useRef as $3i9ps$useRef} from "react";
import {SliderOutput as $3i9ps$SliderOutput, SliderTrack as $3i9ps$SliderTrack} from "react-aria-components/Slider";
import {useLocale as $3i9ps$useLocale} from "react-aria/I18nProvider";
...
const $495db619596088aa$export$44fd664bcca5b6fb = /*#__PURE__*/ (0, $3i9ps$forwardRef)(function ColorSlider(props, ref) {
    ...
    let containerRef = (0, $80ecb974df713a30$export$c2c55ef9111cafd8)(ref);
    ...
    return /*#__PURE__*/ (0, $3i9ps$jsx)((0, $3i9ps$ColorSlider), {
        ...
        className: (renderProps)=>UNSAFE_className + function anonymous(props, overrides) {
                ...
                if (props.orientation === "horizontal") {
                    if (!width) rules += ' Zr131';
                }
                if (props.orientation === "vertical") rules += ' Fs131';
                if (props.orientation === "vertical") rules += ' sb131';
                else if (props.orientation === "horizontal") rules += ' se131';
                rules += ' Dxumf9b131';
                rules += ' CmAQJSd131';
                rules += ' Ub131';
                return rules;
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, $3i9ps$jsx)((0, $3i9ps$SliderTrack), {
                        ...
                        className: function anonymous(props) {
                            ...
                            rules += ' BCPUPs131';
                            rules += ' ACPUPs131';
                            if (props.orientation === "vertical") rules += ' Zo131';
                            else if (props.orientation === "horizontal") rules += ' Za131';
                            if (props.orientation === "vertical") rules += ' Fb131';
                            else if (props.orientation === "horizontal") rules += ' Fp131';
                            rules += ' ob131';
                            rules += ' nb131';
                            rules += ' kb131';
                            rules += ' jb131';
                            ...
                            rules += ' _Mb131';
                            rules += ' _Ka131';
                            if (props.isDisabled) rules += ' _Le131';
                            else rules += ' _Lf131';
                            if (props.isDisabled) rules += ' gH131';
                            return rules;
                        },
