...
var $150382364eecc4bc$exports = require("./useDOMRef.cjs");
var $ac757a4c2bd72aee$exports = require("../../icons/useSpectrumContextProps.cjs");
var $7Qhsa$reactjsxruntime = require("react/jsx-runtime");
var $7Qhsa$reactariacomponentsColorSwatch = require("react-aria-components/ColorSwatch");
...
const $8b1ea085cefae738$export$cae13e90592f246a = /*#__PURE__*/ (0, $7Qhsa$react.forwardRef)(function ColorSwatch(props, ref) {
    ...
    let domRef = (0, $150382364eecc4bc$exports.useDOMRef)(ref);
    ...
    color = (0, $7Qhsa$react.useMemo)(()=>typeof nonNullValue === 'string' ? (0, $7Qhsa$reactariacomponentsColorSwatch.parseColor)(nonNullValue) : nonNullValue, [
        nonNullValue
    ]);
    let swatch = /*#__PURE__*/ (0, $7Qhsa$reactjsxruntime.jsx)((0, $7Qhsa$reactariacomponentsColorSwatch.ColorSwatch), {
        ...props,
        color: color,
        ref: domRef,
        style: ({ color: color })=>({
        ...
        className: function anonymous(props, overrides) {
            ...
            if (props.size === "L") {
                if (!width) rules += ' Zw131';
            } else if (props.size === "M") {
                if (!width) rules += ' ZC131';
            } else if (props.size === "S") {
                if (!width) rules += ' Zo131';
            } else if (props.size === "XS") {
                if (!width) rules += ' Zu131';
            }
            if (props.size === "L") {
                if (!height) rules += ' Fv131';
            } else if (props.size === "M") {
                if (!height) rules += ' Fx131';
            } else if (props.size === "S") {
                if (!height) rules += ' Fp131';
            } else if (props.size === "XS") {
                if (!height) rules += ' Ft131';
            }
            if (props.rounding === "full") rules += ' og131';
            else if (props.rounding === "none") rules += ' od131';
            else if (props.rounding === "default") rules += ' oa131';
            if (props.rounding === "full") rules += ' ng131';
            else if (props.rounding === "none") rules += ' nd131';
            else if (props.rounding === "default") rules += ' na131';
            if (props.rounding === "full") rules += ' kg131';
            else if (props.rounding === "none") rules += ' kd131';
            else if (props.rounding === "default") rules += ' ka131';
            if (props.rounding === "full") rules += ' jg131';
            else if (props.rounding === "none") rules += ' jd131';
            else if (props.rounding === "default") rules += ' ja131';
            rules += ' iz131';
            rules += ' _kb131';
            rules += ' hb131';
            rules += ' mb131';
