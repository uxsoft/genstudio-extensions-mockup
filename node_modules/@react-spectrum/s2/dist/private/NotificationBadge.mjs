...
import {filterDOMProps as $bfWIi$filterDOMProps} from "react-aria/filterDOMProps";
...
import {useLocale as $bfWIi$useLocale} from "react-aria/I18nProvider";
import {useLocalizedStringFormatter as $bfWIi$useLocalizedStringFormatter} from "react-aria/useLocalizedStringFormatter";
...
const $bfb270fb056fefc5$var$badge = function anonymous(props, overrides) {
    ...
    if (props.isDisabled) rules += ' sk131';
    else rules += ' sd131';
    rules += ' uk131';
    rules += ' ucJ9TBTb131';
    rules += ' ud3Euai131';
    ...
    rules += ' _Fd131';
    rules += ' _FnuYUweb131';
    if (props.isStaticColor) rules += ' ph131';
    else rules += ' px131';
    rules += ' plb131';
    rules += ' _jlf131';
    rules += ' _klb131';
    ...
    rules += ' gqMFGYc131';
    rules += ' FRuFGYc131';
    if (props.isSingleDigit) rules += ' fa131';
    else if (props.isIndicatorOnly) rules += ' fa131';
    if (!width) rules += ' ZK131';
    if (props.isDoubleDigit) rules += ' Sv131';
    if (props.isDoubleDigit) rules += ' Rv131';
    rules += ' oh131';
    rules += ' nh131';
    rules += ' kh131';
    rules += ' jh131';
    if (props.isStaticColor) rules += ' -g_-g_c131';
    else rules += ' -g_-g2131';
    rules += ' -g_-lgb131';
    if (props.size === "XL") {
        if (props.isIndicatorOnly) rules += ' -F_-Fspvr8c131';
        else rules += ' -F_-Fm131';
    } else if (props.size === "L") {
        if (props.isIndicatorOnly) rules += ' -F_-Fspvr8c131';
        else rules += ' -F_-Ft131';
    } else if (props.size === "M") {
        if (props.isIndicatorOnly) rules += ' -F_-Fi131';
        else rules += ' -F_-FLb8KJ131';
    } else if (props.size === "S") {
        if (props.isIndicatorOnly) rules += ' -F_-Fi131';
        else rules += ' -F_-Fk131';
    }
